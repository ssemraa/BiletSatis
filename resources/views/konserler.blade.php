...
@section('title', 'Konserler')

@section('content')
<h2 id="yaklasankonserler" class="text-2xl font-bold my-4">Yaklaşan Konserler</h2>
  ...
  async function fetchEvents(page = 1) {
    try {
        const response = await fetch(
            `https://app.ticketmaster.com/discovery/v2/events.json?classificationName=Music&apikey=GmtuhAeXE2g54hjoICBPDlVavYICJ1MJ&countryCode=TR&size=7&sort=date,asc&page=${page - 1}`
        );
